...
<input type="text" name="name" onkeyup="searchInfo()" class="container1__input" placeholder="search books taken">
        ...
        <form  method="post"  action="http://localhost:8080/books/returning">
                   <table height="230" cellspacing="10" cellpadding="8">
                    <tr><td><font color="blue"><b>Return</b></font></td></tr>
                    ...
                    <tr><td>Book code:</td><td><input type=text class="form-control" name="lbc"></td></tr>
                ...
                <h2></h2>
                  ...
                  <div class="section_w250 float_l">
                                <form method="post" action="http://localhost:8080/lib/fine">
                   <table height="230" cellspacing="10" cellpadding="8">
                   <tr><td><font color="blue"><b>Fine</b></font></td></tr>
                   <tr><td>Id no:</td><td> <input type=text class="form-control" name="fin"></td></tr>
...
<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019-2021 </strong> All rights
    reserved.
</footer>
