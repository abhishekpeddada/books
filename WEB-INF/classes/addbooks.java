...
public class addbooks extends HttpServlet
{
          public void doPost(HttpServletRequest req,HttpServletResponse res)
          {
           try
           {
            ...
            String str9 = req.getParameter("url");
            String str10 = req.getParameter("image");
			String str11 = req.getParameter("tags");
...
int r=st.executeUpdate("insert into addbooks values('"+str1+"','"+str2+"','"+str3+"','"+str4+"','"+str5+"','"+str6+"','"+str7+"','"+str8+"','"+str9+"','"+str10+"','"+str11+"')");
