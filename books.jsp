...
PreparedStatement ps=con.prepareStatement("select bn,bc,aut from addbooks where bn like '"+name+"%'");  
...
out.print("<tr bgcolor='#FFDEAD'><th><strong>Book Name</strong></th><th><strong>ISBN</strong></th><th><strong>Author</strong></th></tr>");  
while(rs.next()){  
