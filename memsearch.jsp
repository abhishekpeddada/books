...
PreparedStatement ps=con.prepareStatement("select * from issue where lin like '"+name+"%'");  
...
out.print("<tr bgcolor='#FFDEAD'><th><strong>id no</strong></th><th><strong>book name</strong></th><th><strong>date of issue</strong></th><th><strong>date of expiry</strong></th><th><strong>Book code</strong></th></tr>");  
while(rs.next()){  
